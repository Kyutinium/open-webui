...
_sso_dept_codes_raw = os.environ.get('SSG_DEPT_CODES', '[]')
try:
    SSG_DEPT_CODES = json.loads(_sso_dept_codes_raw)
    if not isinstance(SSG_DEPT_CODES, list):
        SSG_DEPT_CODES = []
...
try:
    ...
    if not isinstance(SSG_D_INDEX_CODES, list):
        SSG_D_INDEX_CODES = []
except (json.JSONDecodeError, TypeError):
    SSG_D_INDEX_CODES = []
...
USER_PERMISSIONS_FEATURES_DATA = os.environ.get('USER_PERMISSIONS_FEATURES_DATA', 'False').lower() == 'true'
...
DEFAULT_USER_PERMISSIONS = {
    ...
    'features': {
        ...
        'data': USER_PERMISSIONS_FEATURES_DATA,
    },
    'settings': {
