...
app.state.config.ENABLE_CONTEXT_USAGE = ENABLE_CONTEXT_USAGE
...
app.include_router(auq.router, prefix='/api/v1/auq', tags=['auq'])
            ...
            **(
                {
                    ...
                    'enable_context_usage': app.state.config.ENABLE_CONTEXT_USAGE,
