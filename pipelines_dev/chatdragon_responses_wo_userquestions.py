"""
title: Development Assistant (Responses, no AskUserQuestion)
author: claude-code-openai-wrapper
version: 0.2.0
description: .
    Stable variant of the Responses pipe that **does not** surface
    AskUserQuestion / sensitive-file permission prompts as cards.
    Useful when the AskUserQuestion card flow is misbehaving and
    you want a known-good chat experience.
    ...
    - No hidden answer-marker handling
    - No <details type="ask_user_question"> emission
license: MIT
"""
...
class Pipeline:
    ...
    def pipes(self) -> list:
        return [
            {
                "id": "chatdragon-responses-wo-userquestions",
                "name": "Chatdragon Responses (no AskUserQuestion)",
            }
        ]
