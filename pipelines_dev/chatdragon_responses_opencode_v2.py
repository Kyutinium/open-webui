"""
title: Chatdragon Responses (OpenCode v2)
...
description: .
    ...
    Pipe id: ``chatdragon-responses-opencode-v2``
license: MIT
"""
...
class Pipeline:
    ...
    def pipes(self) -> list:
        return [
            {
                "id": "chatdragon-responses-opencode-v2",
                "name": "Chatdragon Responses (OpenCode v2)",
            }
        ]
